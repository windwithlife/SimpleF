...
class TaskProjectAddPage extends Page {
  
  final GlobalKey<FormState> _formState = GlobalKey<FormState>();

  //final TaskProjectModel pageModel;
  TaskProjectAddPage();//:pageModel= new TaskProjectModel();

  @override
  void initialize(ModelRegister register){
    //register.registerModel(ChangeNotifierProvider.value(
     //   value: this.pageModel));
       
    print('initialize in tasks-project-add page!');
     this.hasAppBar(true);
    this.initTitle('增加分类项目');
  }
  ...
  Widget _buildTaskScreen(BuildContext context) {
    ...
    TaskProjectModel model = Provider.of<TaskProjectModel>(context);
    return Scaffold(
      //key: _scaffoldState,
      body: ListView(
        children: <Widget>[
          ...
          Form(
            child: Padding(
              ...
              child: TextFormField(
                  ...
                  onSaved: (value) {
                    model.currentProject.name = value;
                  },
                  maxLines: null,
